...
export const transactionAPI = {
  getBalance: () => 
    apiRequest('/transactions/balance'),
  ...
  topUp: (topUpData) => 
    apiRequest('/transactions/top-up', {
      method: 'POST',
...
export const mockAPI = {
  ...
  summary: {
    monthlyTopUps: 1500.00,
    monthlyTransfersOut: 625.50,
    ...
    monthlyData: [1500, 1625, 1700, 1800, 1900, 2000, 2150, 2300, 2450, 2540.75, null, null]
  }
};