...
import { isValidAccountNumber, isValidAmount, isAmountInRange } from '../../utils/validators';
          ...
          <div className="space-y-4">
            ...
            <Input
              ...
              {...register('accountNumber', { 
                ...
                validate: {
                  validAccount: (value) => isValidAccountNumber(value) || 'Please enter a valid account number'
                }
              })}
              error={errors.accountNumber?.message}
              placeholder="e.g. ABC-123456"
              helper="Enter the 6-12 digit account number"
              disabled={isLoading}
              required
            />
